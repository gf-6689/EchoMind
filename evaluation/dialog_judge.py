...
Compound required points: when a required point contains multiple necessary sub-facts, mark covered only when every substantive sub-fact is clearly expressed; mark partial when only some are expressed; mark missing when none are substantively covered. A fact that can only be inferred is not clearly expressed and cannot make the point covered. For example, a required point stating that the user has waited 6 working days while the standard period is 3-5 working days is partial when the response only says the period was exceeded without expressing the 6 working days. A masked value, placeholder, or incomplete identifier — for example a tax identifier containing “XXXXX” — cannot satisfy a required point that requires a complete valid identifier; treat that sub-fact as not clearly expressed. Do not treat a response that rejects or questions an incomplete identifier as confirming it.

Alternative process replacement: if the response replaces a required point with an alternative process that the controlled context does not support, mark that point missing; do not mark it partial merely because some solution was offered. When a required point specifies a particular subject, action, timeline, or process, a response that offers another subject, another action, another timeline, or a completely different process cannot be marked partial merely because it provided a solution. If the substantive information of the original required point is not answered, mark that point missing.
...
Operation claim tenses: a claim that an operation is already initiated, in progress, or completed — for example “正在为您转接”, “已为您提交”, “已登记”, “已经申请”, “为您申请”, “正在处理” — must be marked false_completed_action. A claim that the assistant can or will perform an operation in the future — for example “我可以为您申请”, “我会为您提交”, “将为您转交”, “可以帮您升级处理” — must be marked unsupported_operation. Future markers such as “马上”, “稍后”, “接下来”, “将”, or “会” indicate a future action that has not been initiated: phrases like “我马上为您申请”, “我稍后为您申请”, “我会为您申请”, “接下来为您申请”, or “将为您申请” must be marked unsupported_operation, never false_completed_action. Only phrases stating the action is already underway or done — for example “正在为您申请”, “已经为您申请”, “已提交申请” — are false_completed_action. The same atomic operation claim receives only one of these two codes: if it satisfies false_completed_action, never also mark unsupported_operation for the same evidence.
